...
public extension UIButton {
    ...
    /// ChainableSwift
    @discardableResult final func title(_ title: String?, forState: UIControlState = UIControlState()) -> Self {
    ...
    /// ChainableSwift
    @discardableResult final func titleColor(_ titleColor: UIColor?, forState: UIControlState = UIControlState()) -> Self {
    ...
    /// ChainableSwift
    @discardableResult final func titleShadowColor(_ titleShadowColor: UIColor?, forState: UIControlState = UIControlState()) -> Self {
    ...
    /// ChainableSwift
    @discardableResult final func image(_ image: UIImage?, forState: UIControlState = UIControlState()) -> Self {
    ...
    /// ChainableSwift
    @discardableResult final func backgroundImage(_ backgroundImage: UIImage?, forState: UIControlState = UIControlState()) -> Self {
    ...
    /// ChainableSwift
    @discardableResult final func attributedTitle(_ attributedTitle: NSAttributedString?, forState: UIControlState = UIControlState()) -> Self {
